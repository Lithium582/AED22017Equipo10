...
public class TriePrefixAEDIIGUI extends javax.swing.JFrame {
    ...
    public TriePrefixAEDIIGUI() {
        ...
        String[] palabras =  ManejadorArchivosGenerico.leerArchivo("C:\\Bettina\\UCUDAL\\4TO-SEMESTRE\\ALGORITMOS II\\PredictorTrie\\src\\palabras1.txt");
    ...
    private void jtfSearchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jtfSearchKeyReleased
        ...
        String pnodo = jtfSearch.getText();
        palabras = this.trie.predecir(pnodo);
